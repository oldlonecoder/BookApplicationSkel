...
constexpr T Accent      = "&";
constexpr T AttrSeq     = ":";
constexpr T ColorPair   = "Color";
constexpr T Reset       = "/";
constexpr T ArgSep      = ",";
constexpr T LineBreak   = "br";
constexpr T Left        = "[";
constexpr T Right       = "]";
constexpr T Top         = "^";
...
class APPSKEL_API MarkupTokens : public lex::TokenTable
{
...
//    lex::Type::T = STMLToken::Type::Unset;
//    STMLToken::STMLMnemonic M = STMLToken::STMLMnemonic::Null;
//    STMLToken::BookLexem L = nullptr;
};

} // Book

//#endif //BOOKAPPLICATIONSKEL_MARKUPTOKENS_H
